...
import (
	...
	_ "github.com/Mu-Exchange/Mu-End/game/handler"
	"github.com/Mu-Exchange/Mu-End/game/pkg/base"
	repo2 "github.com/Mu-Exchange/Mu-End/game/repo"
...
func run(components repo.CommonComponents) error {
	...
	app, err := base.BuildComponents(components, func(handler proto.GameHandler, commonComponents repo.CommonComponents) {
		// Register handler
		if err := proto.RegisterGameHandler(srv.Server(), handler); err != nil {
